...
def intro():
    msg = "Assistente - version {} / by: I.A".format(version)
    print("-" * len(msg) + "\n{}\n".format(msg) + "-" * len(msg))


lista_erros = ["Não entendi nada",
               "Desculpe, não entendi",
               "Repita novamente por favor"]

conversas = {"Olá": "oi, tudo bem?",
             "sim e você": "Estou bem obrigada por perguntar",
               "gostaria de ouvir musica": "Qual o estilo de musica preferida?",
                "Tocar rock": "Abrindo o Spotify"

                                                    }


comandos = {"desligar": "desligando",
